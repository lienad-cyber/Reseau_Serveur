                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="left-images">
                            <img src="assets/images/<?= htmlspecialchars($product['url_photo']); ?>" alt="">
                            <img src="assets/images/<?= htmlspecialchars($product['url_second_photo']); ?>" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="right-content">
                            ...
                            <span class="price"> <?= htmlspecialchars($product['prix']); ?> </span>
                            ...
                            <div class="quantity-content">
                                ...
                                <div class="right-content">
                                    <div class="quantity buttons_added">
                                        ...
                                        <input type="number" step="1" min="1" max="" id="qty" name="quantity" value="1"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            quantityInput.addEventListener('input', function () {
                ...
                totalDisplay.textContent = `Total: $${(price * quantity).toFixed(2)}`;
            });
        });

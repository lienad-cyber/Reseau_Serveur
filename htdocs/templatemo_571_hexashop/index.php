                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                ...
                                                <div class="main-border-button">
                                                    <a href="http://localhost:8082/templatemo_571_hexashop/products.php?category=2">Discover More</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                ...
                                                <div class="main-border-button">
                                                <a href="http://localhost:8082/templatemo_571_hexashop/products.php?category=1">Discover More</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="thumb">
                                        ...
                                        <div class="hover-content">
                                            <div class="inner">
                                                ...
                                                <div class="main-border-button">
                                                <a href="http://localhost:8082/templatemo_571_hexashop/products.php?category=3">Discover More</a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            try {
                                ...
                                if ($products) {
                                    foreach ($products as $product) {
                                        $imagePath = "assets/images/" . $product['url_photo'];
                                            ...
                                            <div class="thumb">
                                                <div class="hover-content">
                                                    <ul>
                                                        ...
                                                        <li><a href="single-product.php?id=' . $product['id'] . '"><i class="fa fa-star"></i></a></li>
                                                        <li><a href="single-product.php?id=' . $product['id'] . '"><i class="fa fa-shopping-cart"></i></a></li>
                                                    </ul>
                                                </div>
                                        ...
                                        $fullStars = floor($product['note']);
                                        $halfStar = $product['note'] - $fullStars >= 0.5 ? true : false;
                                    ...
                                    echo "<p>Aucun produit trouvé pour hommes</p>";
                                }
            ...
            <div class="item">
                ...
                <div class="down-content">
                    ...
                    <ul class="stars">';
                                        ...
                                        // Calcul des étoiles pleines, demi-étoile et étoiles vides
                                        $fullStars = floor($product['note']);
                                        $halfStar = $product['note'] - $fullStars >= 0.5 ? true : false;
                                        $emptyStars = 5 - $fullStars - ($halfStar ? 1 : 0);
                                        ...
                                        // Demi-étoile
                                        if ($halfStar) {
                                            echo '<li><i class="fa fa-star-half-o"></i></li>'; // Icône pour la demi-étoile
                                        }
